	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="房间编号" prop="fangjianbianhao">
							<el-input class="list_inp" v-model="form.fangjianbianhao" :readonly="true" placeholder="房间编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="房间楼层" prop="fangjianlouceng">
							<el-input class="list_inp" v-model="form.fangjianlouceng" placeholder="房间楼层"
								 type="text" 								:readonly="!isAdd||disabledForm.fangjianlouceng?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='fangjianbianhao'){
					form.value.fangjianbianhao = row[x];
					disabledForm.value.fangjianbianhao = true;
					continue;
				}
				if(x=='fangjianlouceng'){
					form.value.fangjianlouceng = row[x];
					disabledForm.value.fangjianlouceng = true;
					continue;
				}
				if(x=='fangjianhao'){
