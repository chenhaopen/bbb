				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="家属密码" prop="jiashumima">
							<el-input class="list_inp" v-model="form.jiashumima" placeholder="家属密码"
								type="password" :readonly="!isAdd||disabledForm.jiashumima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiashumima'){
					form.value.jiashumima = row[x];
					disabledForm.value.jiashumima = true;
					continue;
				}
				if(x=='jiashuxingming'){
