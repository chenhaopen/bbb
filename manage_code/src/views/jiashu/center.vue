		...
		<div class="app-contain">
			<el-form class="userinfo_form" ref="userinfoFormRef" :model="form" label-width="$template2.back.add.form.base.labelWidth">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="家属密码" prop="jiashumima">
							<el-input class="list_inp" v-model="user.jiashumima" readonly placeholder="家属密码" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="jiashutouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const jiashutouxiangUploadSuccess=(fileUrls)=> {
