				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="老人姓名" prop="laorenxingming">
							<el-select
								...
								placeholder="请选择老人姓名"
								>
								<el-option v-for="(item,index) in laorenxingmingLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="12">
						<el-form-item label="服务内容" prop="fuwuneirong">
							<el-input v-model="form.fuwuneirong" placeholder="服务内容" type="textarea"
							:readonly="!isAdd||disabledForm.fuwuneirong?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="陪护需求" prop="peihuxuqiu">
							<el-input v-model="form.peihuxuqiu" placeholder="陪护需求" type="textarea"
							:readonly="!isAdd||disabledForm.peihuxuqiu?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='peihuxuqiu'){
					form.value.peihuxuqiu = row[x];
					disabledForm.value.peihuxuqiu = true;
					continue;
				}
			}
			if(row){
