				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="项目简介" prop="xiangmujianjie">
							<el-input class="list_inp" v-model="form.xiangmujianjie" placeholder="项目简介"
								 type="text" 								:readonly="!isAdd||disabledForm.xiangmujianjie?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="项目详情" prop="xiangmuxiangqing">
							<el-input class="list_inp" v-model="form.xiangmuxiangqing" placeholder="项目详情"
								 type="text" 								:readonly="!isAdd||disabledForm.xiangmuxiangqing?true:false" />
						</el-form-item>
					</el-col>
