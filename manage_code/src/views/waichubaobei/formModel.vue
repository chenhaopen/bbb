					...
					<el-col :span="12">
						<el-form-item label="外出时间" prop="waichushijian">
							<el-date-picker
								...
								type="datetime"
								:readonly="!isAdd||disabledForm.waichushijian?true:false"
								placeholder="请选择外出时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="外出原因" prop="waichuyuanyin">
							<el-input v-model="form.waichuyuanyin" placeholder="外出原因" type="textarea"
							:readonly="!isAdd||disabledForm.waichuyuanyin?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='waichuyuanyin'){
					form.value.waichuyuanyin = row[x];
					disabledForm.value.waichuyuanyin = true;
					continue;
				}
				if(x=='waichushijian'){
					form.value.waichushijian = row[x];
					disabledForm.value.waichushijian = true;
					continue;
				}
			}
			if(row){
